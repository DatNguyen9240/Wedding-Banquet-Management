...
WHERE FormName = 'frmBiennhancoccho'
  AND FieldName IN (
    ...
    'Thoigianid', 'Loaitiecid', 'SobanManchinhthuc', 
...
-- 10. Cấu hình Ca Tiệc (Thoigianid), Loại Hình Tiệc (Loaitiecid) thành Select Dropdown và Ngày tổ chức (_Ngaytochuc) thành DatePicker
-- Rename field name in database if it exists as Loaihinhtiecid
...
SET FormatID = 'sl',
    ...
    OrderNo = 2
WHERE FormName = 'frmBiennhancoccho' AND FieldName = 'Loaitiecid';
...
WHERE FormName = 'frmBiennhancoccho'
  AND FieldName IN (
    ...
    'NgayToChuc', 'Thoigianid',      -- Cặp 7: Ngày tổ chức - Ca tiệc
    'Loaitiecid', 'JsonSanhTiec', -- Cặp 8: Loại hình tiệc - Sảnh đặt
