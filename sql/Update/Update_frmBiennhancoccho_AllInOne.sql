...
-- Đăng ký định tuyến các API danh sách cho dropdown (Ca tiệc, Sảnh, Loại hình tiệc)
DELETE FROM WA_API WHERE List IN ('API_DanhSachCaLam', 'API_DanhSachSanh', 'API_DanhSachLoaiHinhTiec');
GO
