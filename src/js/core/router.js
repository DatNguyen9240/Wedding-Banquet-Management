...
var Router = (function () {
  ...
  var ROUTES = [
    ...
    { path: '/form-builder', script: 'src/js/core/DynamicFormEngine.js', module: 'QuanTriHeThong', title: 'Cấu hình Trường Giao diện', pageFn: 'DynamicFormEngine', config: window.APP_MODULES ? window.APP_MODULES.FORM_BUILDER : null },
