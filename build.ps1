...
$cssFiles = @(
  ...
  "components\compare-badge\compare-badge.css",
  "components\metric-card\metric-card.css",
  "components\sparkline\sparkline.css",
  "components\kv-table\kv-table.css",
  "components\hall-gauge\hall-gauge.css",
  ...
  "components\loading-bar\loading-bar.css",
