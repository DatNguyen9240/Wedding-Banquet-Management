...
- [x] **Thông tin Thay đổi – Bổ sung & Sắp đặt tiệc**:
...
- [x] **Luồng dữ liệu tự động điền**: Khách tham quan -> Tự fill data sang Biên nhận cọc chỗ -> Tự fill data sang Hợp đồng.
- [x] **Quản lý Tiền cọc**: Tính toán hiển thị số tiền còn thiếu để đủ 40% giá trị hợp đồng (cọc lần 2).
...
- [x] **Báo cáo động**: Cập nhật logic để các biểu đồ và báo cáo (Doanh thu, Chi phí, Khảo sát) lấy đúng dữ liệu thật từ Backend thay vì Mock Data.
